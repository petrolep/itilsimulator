<?php
/**
 * OperationProblemStateChangeEvent.php
...
/**
 * EventManager event about operation problem state change
 * @package ITILSimulator\Runtime\Events
 */
class OperationProblemStateChangeEvent extends OperationProblemEvent
{
	/** @var string */
