<?php
/**
 * ConfigurationItemStateRequestEvent.php
...
/**
 * EventManager event about ConfigurationItem current state/value
 * @package ITILSimulator\Runtime\Events
 */
class ConfigurationItemStateRequestEvent extends Event
{
	#region "Properties"
	...
	public function __construct($serviceCode, $configurationItemCode, $key)
	{
